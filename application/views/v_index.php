...
instruksi atau fungsi yang berhubungan dengan pengolahan database di 
letakkan dalam model. Sebagai contoh, jika ingin membuat aplikasi
...
yang menghubungkan model dan view, jadi user tidak akan berhubungan 
...
pula yang menampilkan nya ke view. Jadi controller lah yang mengolah intruksi.</p>
            <p allign="justify">Dari penjelasan tentang model view dan controller
...
sangat mudah dalam pengembangan aplikasi degan cara mvc ini karena
...
menangni bagian controller dan modelnya. Jadi pembagian tugas pun
